...
class SaleOrder(models.Model):
    ...
    # ✅ Approval Status for Tree/Form Views - SINGLE definition
    ...
    # ✅ CORRECTED: Compute method for approval_status + next_approver_name
    @api.depends('state', 'sale_approver_line', 'sale_approver_line.approved_order')
